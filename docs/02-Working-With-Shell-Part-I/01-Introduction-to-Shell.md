...
- Finally, we will learn about different types of shells used in Linux (particularly focusing on the bash shell)
...
- Linux shell is a program that allows text based interaction between the user and the operating system, this interaction is carried out by typing commands into the interface and receiving the response in the same way.
...
- Each user in the system gets their own unique home directory with complete access to it (to be able to save, retrieve , delete data).
- Think of it as a dedicated locker assign to you in which you can store or retrieve items.
